...
?>
				...
				<meta charset="utf-8">
						...
						<link rel="stylesheet" type="text/css" href="/breakfast/stylesheets/style.css" />
		...
		<div class="wrap">
			<header> 
				<ul>
					...
					<li>
					<form class="form-wrapper" action="search_brunch.php" method="POST">
        				<input type="text" placeholder="今天我想吃..." required>
