...
switch(pageFrom){
 ...
 //    case 'member':
	...
	case '海華商圈':
		      ...
		      imageArray[0] = new imageObject(0,"海華商圈","assets/realm/hai-hwa/hai-hwa-sogo.jpg");
		      imageArray[1] = new imageObject(1,"海華商圈2","assets/realm/hai-hwa/hai.jpg");
	...
	case '中央大學':
		      ...
		      imageArray[0] = new imageObject(0,"中央大學正門","assets/realm/ncu/ncu_front_door.jpg");
		      imageArray[1] = new imageObject(1,"中央大學","assets/realm/ncu/ncu_bike.jpg");
	...
	case '中原大學':
		      ...
		      imageArray[0] = new imageObject(0,"中原大學大門","assets/realm/cycu/cycu_front_door.jpg");
		      imageArray[1] = new imageObject(1,"中原大學","assets/realm/cycu/cycu_night_market.jpg");

	break;

	case "中壢火車站":

		      imageArray[0] = new imageObject(0,"中壢火車站","assets/realm/train-station/chungli_train.jpg");
