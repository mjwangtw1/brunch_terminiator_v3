...
// $('.popular_all').find('#zone_insideTd').on('click',function(){

//   var zone_insideTd = $(this).html();
...
// $('.popular_all').on('click','#zone_insideTd',function(){
//   //var zone_insideTd = $(this).html();
...
//  $('.user_status>a').html("Wrong Account, please Retry");
...
// //change the log-out button to error msg
// $('.user_status>a').html("Wrong Account, please Retry");
...
// $('#zone_insideTd').on('click',function(){
//   //var zone_insideTd = $(this).html();
